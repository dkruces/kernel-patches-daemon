...
**IMPORTANT**: Before completing any work, you MUST run the following checks to ensure
...
Ensure all checks pass and fix any reported issues before committing. Pay special
attention to:
- Code formatting (black enforces consistent style)
- Linting errors (flake8 catches common issues)
- Test failures
- Trailing whitespace
- Files ending with newlines
